...
import za.co.web_app_platform.app_ws.config.UserPrincipal;
import za.co.web_app_platform.app_ws.constants.AuthorityRoleTypeKeys;
import za.co.web_app_platform.app_ws.constants.BucketName;
import za.co.web_app_platform.app_ws.constants.UserRoleTypeKeys;
import za.co.web_app_platform.app_ws.entity.*;
import za.co.web_app_platform.app_ws.exceptions.UserServiceException;
import za.co.web_app_platform.app_ws.model.response.CategoryRest;
...
import za.co.web_app_platform.app_ws.model.response.ImageUpload;
import za.co.web_app_platform.app_ws.repo.*;
...
public class UserServiceImpl implements UserService {
    ...
    public void uploadUserGalleryImages(String email, MultipartFile file, String caption, String categoryName) {
        ...
        Set<za.co.web_app_platform.app_ws.entity.ImageGallery> imageGalleries = new HashSet<>();
                za.co.web_app_platform.app_ws.entity.ImageGallery imageGallery = new za.co.web_app_platform.app_ws.entity.ImageGallery();
    ...
    @Override
    public Set<ImageGallery> downloadUserGalleryImages(String email) {
        UserProfile userProfile = userRepo.findByEmail(email);
        utils.getUser(userProfile);
    ...
    @Override
    public Set<ImageGallery> fetchGalleryImages(String email) {
        UserProfile userProfile = userRepo.findByEmail(email);
        utils.getUser(userProfile);
        Set<ImageGallery>  imageGalleries = new HashSet<>();
        if (userProfile.getImageGalleries().size() > 0){
    ...
    public Set<ImageGallery> fetchUserImages(String email){
        UserProfile userProfile = userRepo.findByEmail(email);
        utils.getUser(userProfile);
