...
import za.co.web_app_platform.app_ws.SpringApplicationContext;
...
public class SecurityConstants {
    ...
    public static final String GET_ARTICLES_BY_EMAIL_LIST = "/article/articleBy/**";
    public static final String GET_ARTICLES_BY_EMAIL_AND_STATUS = "/article/articlesByStatus/**";
    ...
    public static final String GET_IMAGES_BY_CLIENT_ID = "/api/bucket/download/image/**";
