...
import za.co.web_app_platform.app_ws.model.request.UserLoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        String token = Jwts.builder()
                .setSubject(userName)
                .claim(SecurityConstants.IS_ADMIN, admin)
                .claim(SecurityConstants.USERNAME, user.getUsername())
                .claim(SecurityConstants.NAME,user.getFirstName() + " " + user.getLastName())
